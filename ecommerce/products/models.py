...
def upload_img_path(instance, filename):
    new_filename = random.randint(1, 3899879484)
...
class Product(models.Model):
    ...
    price       = models.DecimalField(max_digits=15, decimal_places=2, default=20.33)
    image       = models.FileField(upload_to='upload_img_path', null=True, blank=True)
